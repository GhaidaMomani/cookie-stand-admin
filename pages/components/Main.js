...
function Main(props) {
  return (
    ...
    <div className=" bg-[#FA8072]  w-2/3 m-7 container mx-auto  text-xl font-medium text-slate-700">
      ...
      <span className="after:content-['*'] after:ml-0.5 after:text-red-500 block text-sm font-medium text-slate-700">
        ...
        />
            ...
            <button className=" m-3 h-3/4 w-1/4 bg-[#D15C51]  hover:bg-sky-700 rounded-xl pt-2" onClick={props.formHandle} >
                Create
            </button>
